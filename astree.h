...
extern PROCFUNCDEF *make_procfuncdef (DECLLIST *fo, IDENT *t, BLOCK *b);
...
extern DECL   *make_procfunc_decl (IDENT *id, DECLLIST *fo, IDENT *t, BLOCK *b);
...
extern TYPE *make_arr_type     (TYPE *idx, TYPE *elt);
extern TYPE *make_ptr_type     (IDENT *id);
extern TYPE *make_rec_type     (FIELDLIST *fl);
...
extern STMTLIST   *make_stmts      (STMT *stmt, STMTLIST *list);
extern STMTIF     *make_stmtif     (EXPR *e, STMT* _then, STMT *_else);
extern STMTREPEAT *make_stmtrepeat (STMTLIST *st, EXPR *e);
extern STMTFOR    *make_stmtfor    (IDENT *id, EXPR *ie, int di, EXPR *to, STMT *st);

extern CASELIST *make_caselist (CASEARM *arm, CASELIST *re);
extern CASEARM  *make_casearm  (EXPRLIST *es, STMT *st);
...
extern STMT *make_compound_stmt(STMTLIST *list);
extern STMT *make_if_stmt      (EXPR *e, STMT *_then, STMT *_else);
extern STMT *make_case_stmt    (EXPR *expr, CASELIST *list);
extern STMT *make_repeat_stmt  (STMTLIST *st, EXPR *e);
extern STMT *make_for_stmt     (IDENT *id, EXPR *ie, int di, EXPR *to, STMT *st);
...
extern FIELD     *make_fbinding (IDENT *id, TYPE *t);
extern FIELDLIST *make_bindflist(FIELD *f, FIELDLIST *ne);
